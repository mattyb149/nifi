...
public class PutCassandraQL extends AbstractCassandraProcessor {
    ...
    static final Relationship REL_SUCCESS = new Relationship.Builder()
            .name("success")
            .description("A FlowFile is routed to this relationship after Cassandra is successfully updated")
            .build();
    static final Relationship REL_RETRY = new Relationship.Builder()
            .name("retry")
            .description("A FlowFile is routed to this relationship if Cassandra cannot be updated but attempting the operation again may succeed")
            .build();
    static final Relationship REL_FAILURE = new Relationship.Builder()
            .name("failure")
            .description("A FlowFile is routed to this relationship if Cassandra cannot be updated and retrying the operation will also fail, "
                    + "such as an invalid statement or an integrity constraint violation")
            .build();
    ...
    public void onTrigger(final ProcessContext context, final ProcessSession session) throws ProcessException {
        ...
        for (FlowFile flowFile : flowFiles) {
            String cql = getCQL(session, flowFile);
            try {
                ...
                if (flowFile == null) {
                    ...
                    logger.error("Unable to execute CQL select statement {} due to {}. No FlowFile to route to failure",
                            new Object[]{cql, e});
                    context.yield();
                } else {
    ...
    private String getCQL(final ProcessSession session, final FlowFile flowFile) {
