...
@XmlType(name = "flowMetrics")
public class FlowMetricsDTO implements Cloneable {
    private String id;
    private String name;
    private Date statsLastRefreshed;

    private FlowMetricsSnapshotDTO aggregateSnapshot;
    private List<NodeFlowMetricsSnapshotDTO> nodeSnapshots;
    ...
    public FlowMetricsSnapshotDTO getAggregateSnapshot() {
        return aggregateSnapshot;
    }

    public void setAggregateSnapshot(FlowMetricsSnapshotDTO aggregateSnapshot) {
    ...
    public List<NodeFlowMetricsSnapshotDTO> getNodeSnapshots() {
        return nodeSnapshots;
    }

    public void setNodeSnapshots(List<NodeFlowMetricsSnapshotDTO> nodeSnapshots) {
