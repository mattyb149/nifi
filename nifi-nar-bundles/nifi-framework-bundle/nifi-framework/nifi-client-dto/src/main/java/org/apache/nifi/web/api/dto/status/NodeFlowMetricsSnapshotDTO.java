...
public class NodeFlowMetricsSnapshotDTO implements Cloneable {

    private String nodeId;
    private String address;
    private Integer apiPort;

    private FlowMetricsSnapshotDTO metricsSnapshot;
    ...
    public FlowMetricsSnapshotDTO getMetricsSnapshot() {
        return metricsSnapshot;
    }

    public void setMetricsSnapshot(FlowMetricsSnapshotDTO metricsSnapshot) {
