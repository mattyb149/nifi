...
public interface GraphClientService extends ControllerService {
    ...
    /**
     * Builds a client-specific query based on a list of property map nodes. Usually followed by a call to executeQuery
     *
     * @param nodeList A List of Maps corresponding to property map nodes
     * @param parameters A Map of parameter values to use in the query and/or execution
     * @return A String query corresponding to an operation on the node list
     */
    String buildQueryFromNodes(List<Map<String, Object>> nodeList, Map<String, Object> parameters);
}