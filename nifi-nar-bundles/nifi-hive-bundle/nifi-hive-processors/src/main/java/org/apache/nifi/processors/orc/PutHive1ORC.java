...
@CapabilityDescription("Reads records from an incoming FlowFile using the provided Record Reader, and writes those records " +
        "to a ORC file in the location/filesystem specified in the configuration. This processor is meant to work with Hive 1.2+.")
...
public class PutHive1ORC extends AbstractPutHDFSRecord {
