...
@Tags({"hive", "hive2", "dbcp", "jdbc", "database", "connection", "pooling", "store"})
@CapabilityDescription("Provides Database Connection Pooling Service for Apache Hive 2. Connections can be asked from pool and returned after usage.")
public class Hive2ConnectionPool extends AbstractControllerService implements Hive2DBCPService {
     ...
     * {@link Hive2ConnectionPool#getConnection()}.  The relogin request is performed in a synchronized block to prevent
    ...
    public String toString() {
        return "Hive2ConnectionPool[id=" + getIdentifier() + "]";
    }
