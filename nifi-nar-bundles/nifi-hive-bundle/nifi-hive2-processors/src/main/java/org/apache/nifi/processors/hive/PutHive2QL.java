...
import org.apache.nifi.dbcp.hive.Hive2DBCPService;
...
@SeeAlso(SelectHive2QL.class)
@InputRequirement(Requirement.INPUT_REQUIRED)
@Tags({"sql", "hive", "hive2", "put", "database", "update", "insert"})
...
public class PutHive2QL extends AbstractHive2QLProcessor {
    ...
    static {
        ...
        _propertyDescriptors.add(HIVE2_DBCP_SERVICE);
    ...
    private InitConnection<FunctionContext, Connection> initConnection = (context, session, fc, ff) -> {
        final Hive2DBCPService dbcpService = context.getProperty(HIVE2_DBCP_SERVICE).asControllerService(Hive2DBCPService.class);
