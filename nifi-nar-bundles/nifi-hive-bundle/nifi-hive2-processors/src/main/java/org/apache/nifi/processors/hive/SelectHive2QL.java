...
@Tags({"hive", "hive2", "sql", "select", "jdbc", "query", "database"})
...
public class SelectHive2QL extends AbstractHive2QLProcessor {
    ...
    private void onTrigger(final ProcessContext context, final ProcessSession session) throws ProcessException {
        ...
        final HiveDBCPService dbcpService = context.getProperty(HIVE2_DBCP_SERVICE).asControllerService(HiveDBCPService.class);
