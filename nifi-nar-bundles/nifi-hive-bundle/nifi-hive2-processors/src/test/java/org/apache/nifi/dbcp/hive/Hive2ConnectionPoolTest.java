...
public class Hive2ConnectionPoolTest {
    private UserGroupInformation userGroupInformation;
    private Hive2ConnectionPool hiveConnectionPool;
    ...
    private void initPool() throws Exception {
        hiveConnectionPool = new Hive2ConnectionPool();

        Field ugiField = Hive2ConnectionPool.class.getDeclaredField("ugi");
        ugiField.setAccessible(true);
        ugiField.set(hiveConnectionPool, userGroupInformation);

        Field dataSourceField = Hive2ConnectionPool.class.getDeclaredField("dataSource");
        ...
        Field kerberosPropertiesField = Hive2ConnectionPool.class.getDeclaredField("kerberosProperties");
    ...
    public void testExpressionLanguageSupport() throws Exception {
        ...
        Map<PropertyDescriptor, String> props = new HashMap<PropertyDescriptor, String>() {{
            put(Hive2ConnectionPool.DATABASE_URL, "${url}");
            put(Hive2ConnectionPool.DB_USER, "${username}");
            put(Hive2ConnectionPool.DB_PASSWORD, "${password}");
            put(Hive2ConnectionPool.MAX_TOTAL_CONNECTIONS, "${maxconn}");
            put(Hive2ConnectionPool.MAX_WAIT_TIME, "${maxwait}");
            put(Hive2ConnectionPool.HIVE_CONFIGURATION_RESOURCES, "${hiveconf}");
        }};
    ...
    public void testKerberosAuthException() throws Exception {
        ...
        Map<PropertyDescriptor, String> props = new HashMap<PropertyDescriptor, String>() {{
            put(Hive2ConnectionPool.DATABASE_URL, "${url}");
            put(Hive2ConnectionPool.HIVE_CONFIGURATION_RESOURCES, "${conf}");
