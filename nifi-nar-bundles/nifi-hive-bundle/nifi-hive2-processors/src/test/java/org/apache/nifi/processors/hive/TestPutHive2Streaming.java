...
import static org.apache.nifi.processors.hive.AbstractHive2QLProcessor.ATTR_OUTPUT_TABLES;
import static org.apache.nifi.processors.hive.PutHive2Streaming.HIVE_STREAMING_RECORD_COUNT_ATTR;
import static org.apache.nifi.processors.hive.PutHive2Streaming.REL_SUCCESS;
...
/**
 * Unit tests for PutHive2Streaming processor.
 */
public class TestPutHive2Streaming {

    private TestRunner runner;
    private MockPutHive2Streaming processor;
    ...
    public void setUp() throws Exception {
        ...
        processor = new MockPutHive2Streaming();
    ...
    public void testSetup() throws Exception {
        ...
        runner.setProperty(PutHive2Streaming.METASTORE_URI, "thrift://localhost:9083");
        runner.setProperty(PutHive2Streaming.DB_NAME, "default");
        runner.assertNotValid();
        runner.setProperty(PutHive2Streaming.TABLE_NAME, "users");
        runner.assertValid();
        runner.run();
    }
    ...
    public void testSetupBadPartitionColumns() throws Exception {
        ...
        runner.setProperty(PutHive2Streaming.TABLE_NAME, "users");
        runner.assertValid();
        runner.setProperty(PutHive2Streaming.PARTITION_COLUMNS, "favorite_number,,");
        runner.setProperty(PutHive2Streaming.AUTOCREATE_PARTITIONS, "true");
        runner.assertNotValid();
    }
    ...
    public void testSetupWithKerberosAuthFailed() throws Exception {
        ...
        runner.setProperty(PutHive2Streaming.DB_NAME, "default");
        runner.setProperty(PutHive2Streaming.TABLE_NAME, "users");
        runner.setProperty(PutHive2Streaming.HIVE_CONFIGURATION_RESOURCES, "src/test/resources/core-site-security.xml, src/test/resources/hive-site-security.xml");
    ...
    public void testSingleBatchInvalid() throws Exception {
        ...
        runner.setProperty(PutHive2Streaming.DB_NAME, "default");
        runner.setProperty(PutHive2Streaming.TABLE_NAME, "users");
        runner.setProperty(PutHive2Streaming.TXNS_PER_BATCH, "2");
        runner.assertValid();
        runner.setProperty(PutHive2Streaming.TXNS_PER_BATCH, "1");
        runner.assertNotValid();
    }
    ...
    public void onTrigger() throws Exception {
        ...
        runner.setProperty(PutHive2Streaming.DB_NAME, "default");
        runner.setProperty(PutHive2Streaming.TABLE_NAME, "users");
        runner.setProperty(PutHive2Streaming.TXNS_PER_BATCH, "100");
        Map<String, Object> user1 = new HashMap<String, Object>() {
            {
                put("name", "Joe");
                put("favorite_number", 146);
        ...
        runner.assertTransferCount(PutHive2Streaming.REL_SUCCESS, 1);
        final MockFlowFile flowFile = runner.getFlowFilesForRelationship(PutHive2Streaming.REL_SUCCESS).get(0);
    ...
    public void onTriggerBadInput() throws Exception {
        ...
        runner.assertTransferCount(PutHive2Streaming.REL_FAILURE, 1);
    }
    ...
    public void onTriggerBadInputRollbackOnFailure() throws Exception {
        ...
        runner.setProperty(PutHive2Streaming.TABLE_NAME, "users");
        runner.setProperty(PutHive2Streaming.TXNS_PER_BATCH, "100");
        runner.setProperty(PutHive2Streaming.ROLLBACK_ON_FAILURE, "true");
        runner.enqueue("I am not an Avro record".getBytes());
        try {
            runner.run();
        ...
        runner.assertTransferCount(PutHive2Streaming.REL_FAILURE, 0);
    ...
    public void onTriggerMultipleRecordsSingleTransaction() throws Exception {
        ...
        runner.setProperty(PutHive2Streaming.DB_NAME, "default");
        runner.setProperty(PutHive2Streaming.TABLE_NAME, "users");
        runner.setProperty(PutHive2Streaming.RECORDS_PER_TXN, "100");
        Map<String, Object> user1 = new HashMap<String, Object>() {
            {
                put("name", "Joe");
                put("favorite_number", 146);
        ...
        runner.assertTransferCount(PutHive2Streaming.REL_SUCCESS, 1);
        MockFlowFile resultFlowFile = runner.getFlowFilesForRelationship(PutHive2Streaming.REL_SUCCESS).get(0);
    ...
    public void onTriggerMultipleRecordsMultipleTransaction() throws Exception {
        ...
        runner.setProperty(PutHive2Streaming.DB_NAME, "default");
        runner.setProperty(PutHive2Streaming.TABLE_NAME, "users");
        runner.setProperty(PutHive2Streaming.RECORDS_PER_TXN, "2");
        Map<String, Object> user1 = new HashMap<String, Object>() {
            {
                put("name", "Joe");
                put("favorite_number", 146);
    ...
    public void onTriggerMultipleRecordsFailInMiddle() throws Exception {
        ...
        runner.assertTransferCount(PutHive2Streaming.REL_SUCCESS, 1);
        runner.assertTransferCount(PutHive2Streaming.REL_FAILURE, 1);
        runner.assertTransferCount(PutHive2Streaming.REL_RETRY, 0);

        MockFlowFile resultFlowFile = runner.getFlowFilesForRelationship(PutHive2Streaming.REL_SUCCESS).get(0);
        assertOutputAvroRecords(Arrays.asList(user1, user3, user4), resultFlowFile);

        final MockFlowFile failedFlowFile = runner.getFlowFilesForRelationship(PutHive2Streaming.REL_FAILURE).get(0);
    ...
    public void onTriggerMultipleRecordsFailInMiddleRollbackOnFailure() throws Exception {
        ...
        runner.assertTransferCount(PutHive2Streaming.REL_SUCCESS, 0);
        runner.assertTransferCount(PutHive2Streaming.REL_RETRY, 0);
        runner.assertTransferCount(PutHive2Streaming.REL_FAILURE, 0);
        // Assert incoming FlowFile stays in input queue.
        assertEquals(1, runner.getQueueSize().getObjectCount());
    ...
    private void assertOutputAvroRecords(List<Map<String, Object>> expectedRecords, MockFlowFile resultFlowFile) throws IOException {
        assertEquals(String.valueOf(expectedRecords.size()), resultFlowFile.getAttribute(PutHive2Streaming.HIVE_STREAMING_RECORD_COUNT_ATTR));
    ...
    public void onTriggerWithPartitionColumns() throws Exception {
        ...
        runner.setProperty(PutHive2Streaming.METASTORE_URI, "${metastore}");
        runner.setProperty(PutHive2Streaming.DB_NAME, "${database}");
        runner.setProperty(PutHive2Streaming.TABLE_NAME, "${table}");
        runner.setProperty(PutHive2Streaming.TXNS_PER_BATCH, "100");
        runner.setProperty(PutHive2Streaming.PARTITION_COLUMNS, "${partitions}");
        runner.setProperty(PutHive2Streaming.AUTOCREATE_PARTITIONS, "true");
    ...
    public void onTriggerWithPartitionColumnsNotInRecord() throws Exception {
        ...
        runner.setProperty(PutHive2Streaming.TABLE_NAME, "users");
        runner.setProperty(PutHive2Streaming.TXNS_PER_BATCH, "100");
        runner.setProperty(PutHive2Streaming.PARTITION_COLUMNS, "favorite_food");
        runner.setProperty(PutHive2Streaming.AUTOCREATE_PARTITIONS, "false");
        Map<String, Object> user1 = new HashMap<String, Object>() {
            {
                put("name", "Joe");
                put("favorite_number", 146);
    ...
    public void onTriggerWithRetireWriters() throws Exception {
        ...
        runner.assertTransferCount(PutHive2Streaming.REL_SUCCESS, 10);
        runner.assertTransferCount(PutHive2Streaming.REL_FAILURE, 0);
        runner.assertTransferCount(PutHive2Streaming.REL_RETRY, 0);
    }
    ...
    public void onTriggerWithHeartbeat() throws Exception {
        ...
        runner.setProperty(PutHive2Streaming.TABLE_NAME, "users");
        runner.setProperty(PutHive2Streaming.TXNS_PER_BATCH, "100");
        runner.setProperty(PutHive2Streaming.HEARTBEAT_INTERVAL, "1");
        Map<String, Object> user1 = new HashMap<String, Object>() {
            {
                put("name", "Joe");
                put("favorite_number", 146);
        ...
        runner.enqueue(createAvroRecord(Collections.singletonList(user1)));
        runner.run(1, true);
        runner.assertTransferCount(PutHive2Streaming.REL_SUCCESS, 2);
        runner.assertTransferCount(PutHive2Streaming.REL_FAILURE, 0);
        runner.assertTransferCount(PutHive2Streaming.REL_RETRY, 0);
    }
    ...
    public void onTriggerWithConnectFailure() throws Exception {
        ...
        runner.assertTransferCount(PutHive2Streaming.REL_RETRY, 1);
        runner.assertTransferCount(PutHive2Streaming.REL_FAILURE, 0);
        runner.assertTransferCount(PutHive2Streaming.REL_SUCCESS, 0);
    }
    ...
    public void onTriggerWithWriteFailure() throws Exception {
        ...
        runner.assertTransferCount(PutHive2Streaming.REL_FAILURE, 1);
        final MockFlowFile flowFile = runner.getFlowFilesForRelationship(PutHive2Streaming.REL_FAILURE).get(0);
    ...
    private class MockPutHive2Streaming extends PutHive2Streaming {
    ...
    private class MockHiveWriter extends HiveWriter {
        ...
        public MockHiveWriter(HiveEndPoint endPoint, int txnsPerBatch, boolean autoCreatePartitions,
            ...
            assertEquals(TestPutHive2Streaming.this.ugi, ugi);
