...
var ProcessorService =  function ProcessorService($http) {
    ...
    function setProperties(processorId,revisionId,clientId,disconnectedNodeAcknowledged,properties){
        ...
        return $http({url: 'api/joltrecord/processor/properties?'+urlParams,method:'PUT',data:properties});
    }

    function getType(id) {
        return $http({
            url: 'api/joltrecord/processor/details?processorId=' + id,
            method: 'GET',
    ...
    function getDetails(id) {
        return $http({ url: 'api/joltrecord/processor/details?processorId=' + id, method: 'GET'});
    }
...
angular.module('joltTransformRecordUI').factory('ProcessorService', ProcessorService);
