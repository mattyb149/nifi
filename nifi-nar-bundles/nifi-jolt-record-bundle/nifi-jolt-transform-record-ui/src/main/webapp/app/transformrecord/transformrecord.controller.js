...
var TransformJsonController = function ($scope, $state, $q, $mdDialog, $timeout, TransformJsonService, ProcessorService, details) {
    ...
    $scope.getJsonSpec = function(details){
        if(details['properties']['jolt-record-spec'] != null && details['properties']['jolt-record-spec'] != "") {
            return details['properties']['jolt-record-spec'];
        }
        else return '';
    };

    $scope.getTransform = function(details){
        return details['properties']['jolt-record-transform'] ? details['properties']['jolt-record-transform'] :
            details['descriptors']['jolt-record-transform']['defaultValue'] ;
    };
    ...
    $scope.getTransformOptions = function(details){
        return $scope.convertToArray(details['descriptors']['jolt-record-transform']['allowableValues']);
    };
    ...
    $scope.getProperties = function(transform,jsonSpec){
        ...
        return {
            "jolt-record-transform" : transform != "" ? transform : null,
            "jolt-record-spec": jsonSpec != "" ? jsonSpec : null
        };
    ...
    $scope.showVariableDialog = function(ev) {
        ...
        $mdDialog.show({
            ...
            templateUrl: 'app/transformrecord/variable-dialog-template.html',
            targetEvent: ev,
...
angular.module('joltTransformRecordUI').controller('TransformJsonController', TransformJsonController);
