...
public class TestProcessorResource extends JerseyTest {
    ...
    public void testSetProperties() {
        ...
        properties.put("jolt-record-transform","jolt-transform-chain");
        ...
        Response response = client().target(getBaseUri())
                .path("/joltrecord/processor/properties")
        ...
        assertTrue(jsonNode.get("properties").get("jolt-record-transform").asText().equals("jolt-transform-chain"));
    }
    ...
    public void testGetProcessorDetails() {
        ...
        descriptors.put("jolt-record-transform",descriptor);
        final ComponentDetails componentDetails = new ComponentDetails.Builder().name("mytransform").type("org.apache.nifi.processors.jolt.record.JoltTransformRecord")
        ...
        JsonNode value = client().target(getBaseUri())
                .path("/joltrecord/processor/details")
                .queryParam("processorId","1")
                .request()
                .get(JsonNode.class);
