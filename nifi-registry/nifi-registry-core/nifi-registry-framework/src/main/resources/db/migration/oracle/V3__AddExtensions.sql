...
CREATE TABLE BUNDLE_VERSION_DEPENDENCY (
    ...
    ARTIFACT_ID VARCHAR(200) NOT NULL,
    VERSION VARCHAR(100) NOT NULL,
    FOREIGN KEY (BUNDLE_VERSION_ID) REFERENCES BUNDLE_VERSION(ID) ON DELETE CASCADE,
...
CREATE TABLE EXTENSION (
    ...
    ADDITIONAL_DETAILS VARCHAR(4000),
...
ALTER TABLE BUCKET ADD ALLOW_EXTENSION_BUNDLE_REDEPLOY INT DEFAULT 0;