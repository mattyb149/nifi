...
-- NOTE: This file is here to keep same version history as the default migrations, but since Oracle came
-- later, the cascades are part of the original constraints in oracle/V2_Initial.sql
